        ...
        <footer className='bg-gray-950 px-4 md:px-16 lg:px-28 py-8'>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                ...
                <div>
                    ...
                    <li><a href="" className="hover:underline text-gray-300">Delivery Information</a></li>
                ...
                <div className=''>
                    ...
                    <li>{" "} <FaInstagram className="text-orange-500"/>{" "} <a href="" className="hover:underline text-gray-300"> Instagram </a></li>
